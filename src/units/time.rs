...
create_non_standard_unit!(Minute, Second, 60.0, "minute", "m");
...
create_non_standard_unit!(Fortnight, Second, 3600.0 * 24.0 * 14.0, "fortnight", "fortnight");
create_non_standard_unit!(Month, Second, (30.0 * 24.0 + 10.5) * 3600.0, "month", "month");
create_non_standard_unit!(Year, Second, 3600.0 * 24.0 * 365.0, "year", "year");
create_non_standard_unit!(CommonYear, Second, 365.25 * 24.0 * 3600.0, "common year", "cy");
create_non_standard_unit!(Decade, Second, 3600.0 * 24.0 * 365.0 * 10.0, "decade", "decade");
create_non_standard_unit!(Century, Second, 3600.0 * 24.0 * 365.0 * 100.0, "century", "century");